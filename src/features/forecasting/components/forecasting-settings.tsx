    ...
    <div className="flex flex-col gap-4 rounded-lg border bg-card p-4 shadow-sm md:flex-row md:items-center md:justify-between">
      <div className="flex flex-col gap-4 md:flex-row md:items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            <Label htmlFor="baseMonth" className="text-xs text-muted-foreground">Mês Base Real</Label>
            <Input
              id="baseMonth"
              type="month"
              value={baseDate}
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            <Label htmlFor="modelSelect" className="text-xs text-muted-foreground">Motor Preditivo</Label>
            <Select value={model} onValueChange={(val) => handleParamChange("model", val)}>
              <SelectTrigger id="modelSelect" className="h-8 w-[200px]">
                <SelectValue placeholder="Modelo Matemático" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="MOVING_AVERAGE">Média Móvel (3 Meses)</SelectItem>
                <SelectItem value="STRAIGHT_LINE">Linha Reta (Tendência)</SelectItem>
                <SelectItem value="EXPONENTIAL_SMOOTHING">Suavização Exponencial</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            <Label htmlFor="modeSelect" className="text-xs text-muted-foreground">Regime</Label>
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-2">
          ...
          />
          <Label htmlFor="show-av" className="text-sm">Análise Vertical (AV)</Label>
        </div>
        <div className="flex items-center gap-2">
          <Switch 
            id="show-ah" 
          ...
          />
          <Label htmlFor="show-ah" className="text-sm">Análise Horizontal (AH)</Label>
        </div>
      </div>
    </div>
  )
